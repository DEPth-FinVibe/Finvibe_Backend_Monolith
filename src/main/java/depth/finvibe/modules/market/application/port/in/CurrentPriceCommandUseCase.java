...
public interface CurrentPriceCommandUseCase {
    ...
    void registerWatchingStock(Long stockId, Long userId);

    // 활성 구독의 watcher TTL 연장
    void renewWatchingStock(Long stockId, Long userId);

    //유저가 보고있는 종목 해제 (실시간 종목 카운트 감소)ø
    void unregisterWatchingStock(Long stockId, Long userId);
