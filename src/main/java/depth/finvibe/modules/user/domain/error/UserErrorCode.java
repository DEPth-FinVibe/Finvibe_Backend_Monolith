...
public enum UserErrorCode implements DomainErrorCode {
  ...
  REFRESH_TOKEN_REUSED("REFRESH_TOKEN_REUSED", "재사용된 리프레시 토큰이 감지되었습니다."),
  INVALID_TEMPORARY_TOKEN("INVALID_TEMPORARY_TOKEN", "임시 토큰이 유효하지 않습니다."),
  TOKEN_FAMILY_NOT_FOUND("TOKEN_FAMILY_NOT_FOUND", "로그인 기기 정보를 찾을 수 없습니다."),
  UNAUTHORIZED_TOKEN_FAMILY_ACCESS("UNAUTHORIZED_TOKEN_FAMILY_ACCESS", "해당 로그인 기기에 접근할 권한이 없습니다."),
  MISSING_TOKEN_FAMILY("MISSING_TOKEN_FAMILY", "현재 로그인 기기 정보를 확인할 수 없습니다."),
