...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handleBadRequest(Exception ex) {
		List<FieldErrorResponse> fieldErrors = extractFieldErrors(ex);
	...
	private List<FieldErrorResponse> extractFieldErrors(Exception ex) {
		if (ex instanceof MethodArgumentNotValidException manvEx) {
			return manvEx.getBindingResult().getFieldErrors().stream()
		...
		if (ex instanceof ConstraintViolationException cvEx) {
			return cvEx.getConstraintViolations().stream()
