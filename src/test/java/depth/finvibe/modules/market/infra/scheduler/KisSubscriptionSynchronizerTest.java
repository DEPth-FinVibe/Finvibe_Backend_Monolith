...
class KisSubscriptionSynchronizerTest {
    ...
    @Test
    @DisplayName("예약·보유·감시 종목을 함께 실시간 구독한다")
    void syncRealtimeSubscriptions_allStockSources_success() {
        // given
    ...
    @Test
    @DisplayName("여러 소스에 중복된 활성 종목은 한 번만 구독한다")
    ...
    @Test
    @DisplayName("보유 종목만 존재해도 실시간 구독한다")
    void syncRealtimeSubscriptions_onlyHoldingStocks_success() {
        // given
    ...
    @Test
    @DisplayName("감시 종목이 quota를 초과해도 모든 보유 종목을 구독한다")
    void syncRealtimeSubscriptions_watchersExceedQuota_preservesAllHoldings() {
        // given
    ...
    @Test
    @DisplayName("Mock provider에서는 quota 없이 모든 감시 종목을 구독한다")
    void syncRealtimeSubscriptions_mockProvider_ignoresQuota() {
        // given
    ...
    @Test
    @DisplayName("quota가 줄어도 보유 종목 구독은 해제하지 않는다")
    void syncRealtimeSubscriptions_quotaShrinks_neverEvictsHoldings() {
        // given
